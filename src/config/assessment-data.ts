    ...
    questions: [
      {
        ...
        l4Label:   { de: 'Weitgehend einheitliches Modell, Data Catalog im Aufbau',                                             en: 'Largely unified model, Data Catalog under construction' },
      ...
      },
      {
        ...
        highLabel: { de: 'Streaming-Architektur (Kafka, Event Hub) für Sub-Minuten-Latenz operativ',                            en: 'Streaming architecture (Kafka, Event Hub) for sub-minute latency operational' },
      },
    ],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        l3Label:   { de: 'Erste Data Engineers eingestellt, Team im Aufbau',                                                    en: 'First Data Engineers hired, team under construction' },
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        l2Label:   { de: 'Use Cases auf Zuruf, kein systematisches Scoring oder Priorisierung',                                 en: 'Use cases on request, no systematic scoring or prioritization' },
      ...
      },
      {
        ...
        highLabel: { de: 'Dedizierter Trend-Radar-Prozess mit regelmäßigem Board-Briefing und konkreten Handlungsableitungen',  en: 'Dedicated trend radar process with regular board briefing and concrete action derivations' },
      },
      {
        id: 'strat_7',
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        l4Label:   { de: 'Regelmäßige Ergebniskommunikation, Dashboard in Aufbau',                                              en: 'Regular results communication, dashboard under construction' },
