...
const MOCK_CASES: UseCase[] = [
  {
    ...
    weighted_score: 3.8, quadrant: 'quick_win', canvas_id: null, governance_result: null, created_at: '', updated_at: '',
  },
  {
    ...
    weighted_score: 3.4, quadrant: 'strategic_bet', canvas_id: null, governance_result: null, created_at: '', updated_at: '',
  },
]
