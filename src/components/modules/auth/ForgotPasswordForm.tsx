...
export function ForgotPasswordForm() {
  ...
  if (sent) {
    return (
      <div className="bg-white border border-slate-200 rounded-2xl p-4 sm:p-8 text-center">
        ...
        <h2 className="text-slate-900 text-lg font-semibold mb-2">E-Mail unterwegs</h2>
        <p className="text-slate-500 text-sm leading-relaxed mb-6">
          Falls ein Konto mit <strong className="text-slate-900">{email}</strong> existiert,
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-2xl p-4 sm:p-8">
      <h1 className="text-slate-900 text-xl sm:text-2xl font-semibold font-serif mb-2">Passwort vergessen</h1>
