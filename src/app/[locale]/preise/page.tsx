...
// Bewusste Ausnahme vom statischen Rendering der übrigen öffentlichen Seiten:
// Diese Seite liest Preise und aktive Promotions über getPublicPricing() live aus
// der Datenbank (admin-konfigurierbar über price_config / promotions). Würde sie
// zur Buildzeit vorgerendert, wäre eine im Admin geänderte Preis- oder Promo-Angabe
// erst nach dem nächsten Deployment sichtbar — bei Preisen keine akzeptable Latenz.
//
// Falls die Seite später doch gecacht werden soll, ist `export const revalidate = 60`
// die naheliegende Alternative (Preisänderung dann binnen einer Minute sichtbar).
// Bewusst nicht ohne Rücksprache gesetzt, weil es Preisdarstellung betrifft.
