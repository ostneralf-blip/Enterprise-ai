...
export default async function Page() {
  ...
  const requiredTier = ['compliance', 'architecture'].includes('architecture') ? 'pro' : 'free'
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-2xl font-semibold text-slate-900 capitalize">architecture</h1>
